...
describe("TypeScriptParser", () => {
    ...
    it("errors when module source file do not exist", function(this: This) {
        ...
        const parser = new TypeScriptParser({sourceRoot: '.', sources: ["missingfile.js"]}, undefined, undefined, false, 'uft8');
        parser.parse();
    ...
    it("retains a source file if it contains exported declarations", function(this: This) {
        ...
        const parser = new TypeScriptParser({sourceRoot: '.', sources: ["src.ts"]}, undefined, undefined, false, 'uft8');
    ...
    it("merges members from two declarations of the same interface", function(this: This) {
        ...
        `]]);
        this.createProgramMethod.and.callFake(() => program);
        const parser = new TypeScriptParser({sourceRoot: '.', sources: ["src.ts"]}, undefined, undefined, true, 'uft8');
        const module = parser.parse();
        expect(log.errorCount).toBe(0);
        expect(log.warningCount).toBe(0);
        expect(log.warningCount).toBe(0);
    ...
    it("has an any type when missing type information", function(this: This) {
        ...
        this.createProgramMethod.and.callFake(() => program);
        const parser = new TypeScriptParser({sourceRoot: '.', sources: ["source.ts"]}, undefined, undefined, true, 'uft8');
        const module = parser.parse();
