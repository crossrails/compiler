...
describe("SourceFile", () => {
    ...
    it("creates non exported declarations when implicitExport option specified", function(this: This) {
        let sourceFile = new this.ast.SourceFile(ts.createSourceFile('source.js', "let declaration", ts.ScriptTarget.ES6, true), true, {} as any, {} as any);
    ...
    it("creates variable declarations for each declaration in a variable statement", function(this: This) {
        let sourceFile = new this.ast.SourceFile(ts.createSourceFile('source.js', "export let a1, a2; export let b1;", ts.ScriptTarget.ES6, true), false, {} as any, {identifiers: new Set()} as any);
